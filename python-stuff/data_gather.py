...
def get_stock_metrics(ticker_symbols, start_date=None, end_date=None):
    """
    Fetch comprehensive financial metrics for given stock tickers.
...
if __name__ == "__main__":
    ...
    # Get the data
    results = get_stock_metrics(symbols)
    
    # Save to Excel
    save_to_excel(results, 'stock_analysis.xlsx')