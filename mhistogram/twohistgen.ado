*! v1 Based on twoway__histogram_gen
* This allows using noninteger values for histogram 
* version 1.1.15  16feb2015
// generate heights and bin centers for a histogram
program twohistgen, rclass sortpreserve
	version 8.0

	syntax varname(numeric) [ iw fw] [if] [in]	///
	[,					///
		DISCrete			///
